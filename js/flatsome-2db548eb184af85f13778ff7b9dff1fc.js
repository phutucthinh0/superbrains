!(function (t) {
      ...
      (function (n, o) {
        ...
        function r(e) {
          if (
            ...
            for (
              var u = (a.isBorderBox = "border-box" == r.boxSizing), h = 0;
              h < c;
              h++
            ) {
              var d = l[h],
          ...
          getInline: function (i, n) {
            if ((O(), i.src)) {
              ...
              if (r.length) {
                ...
                s &&
                  s.tagName &&
                  (P || ((I = o.hiddenClass), (P = C(I)), (I = "mfp-" + I)),
            ...
            return (
              ...
              !(!i || !i.enabled) &&
                ...
                S("UpdateStatus" + o, function (t, i) {
                  i.text &&
                    (i.text = V(i.text, e.currItem.index, e.items.length));
                }),
        ...
        reposition: function () {
          ...
          if (0 !== t("body").find(o.$tooltip).length) {
            ...
            if (
              ...
              "top-right" == L &&
                ((I = a.offset.left + a.dimension.width + O - l),
                (j = a.offset.top - c - A - 12),
                i(),
            ...
            if ("right" == L) {
              ...
              if (((j = a.offset.top - M / 2 - A), I + l > s && P < 0)) {
                ...
                I + l > s && ((I = a.offset.left - O - l - 12), (r = "right"));
            }
            if (o.options.arrow) {
  ...
  function (t, e, i) {
    t.exports =
      ...
      !i(44)(function () {
        return (
          7 !=
          Object.defineProperty(i(45)("div"), "a", {
            get: function () {
              return 7;
            },
          }).a
    ...
    var n = i(34),
      ...
      K = function (t, e) {
        if (((t = b(t)), (e = w(e, !0)), t !== W || !o(F, e) || o(N, e))) {
          var i = _(t, e);
          return (
            !i || !o(F, e) || (o(t, D) && t[D][e]) || (i.enumerable = !0), i
          );
        }
      },
      Z = function (t) {
  ...
  function (t, e) {
    ...
    function c() {
      function t(t, e) {
        return t[h] && t[h].img && ("src" === e || "srcset" === e)
          ? t[h].img
          : t;
      }
      m ||
    ...
    function u(t, e) {
      ...
      "img" === t
        ...
        : "length" in t || (t = [t]);
      for (var n = 0; n < t.length; n++)
        (t[n][h] = t[n][h] || { skipTest: e.skipTest }), a(t[n]);
      i &&
    ...
    !(function (t, e) {
      ...
      function i(t) {
        ...
        var e = this.boundingClientRect,
          ...
          o = n.width * n.height;
        i
          ? (this.intersectionRatio = Number((o / i).toFixed(4)))
          ...
          case "element":
            (x = b * o),
              ...
              "undefined" != typeof e.dataset.parallaxFade &&
                (e.style.opacity = o ? d(1 - w).toFixed(2) : null);
        }
    }
    function a(t) {
            ...
            (
              ...
              : ((h = a / s),
                ...
                "top" === e["object-position-y"]
                  ...
                  ? (n.marginTop = Math.round(l - h) + "px")
                  : (n.marginTop = Math.round((l - h) / 2) + "px")),
            t.autoplay && t.play();
        }
  ...
  function (t, e) {
    ...
    Flatsome.behavior("lightbox-image", {
      attach: function (t) {
        jQuery(
          '.lightbox *[id^="attachment"] a[href*=".jpg"],.lightbox *[id^="attachment"] a[href*=".jpeg"],.lightbox .wp-block-image a[href*=".jpg"]:not([target="_blank"]),.lightbox .wp-block-image a[href*=".jpeg"]:not([target="_blank"]),.lightbox a.image-lightbox,.lightbox .entry-content a[href*=".jpg"],.lightbox .entry-content a[href*=".jpeg"]',
          t
        )
          .not(
